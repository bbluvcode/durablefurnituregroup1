...
function CompareItem3(props) {
  const { compareitem3 } = useSelector((state) => state.shopReducer);
  const [selectedProduct, setSelectedProduct] = useState(compareitem3);
  ...
  useEffect(() => {
    setSelectedProduct(compareitem3);
  }, [compareitem3]);
      ...
      <div className="card text-start compare-product-right">
        ...
        <div className="card-body">
          ...
          <div
            ...
            onClick={() => {
              dispatch(changeProductToCompare3());
            }}
          >
